...
helpURL='https://www.mathworks.com/help/matlab/learn_matlab/scripts.html';
web(helpURL)
...
% By typing ver and hitting enter
ver
...
%
% Answer: 'for' statement loops a specific number of times, and keep track
%          of each iteration with an icrementing index variables
...
%
% Answer: Not a Number. Expressions like 0/0 and inf result in NaN
%
...
fprintf('hello world')
prompt = 'who are we saying hello to?'
str = input (prompt, 's')
